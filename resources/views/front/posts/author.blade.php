                ...
                <div class="row">
                    ...
                    <div class="post col-xl-6">
                        ...
                        <div class="post-details">
                            ...
                            <footer class="post-footer d-flex align-items-center"><a href="{{ route('front.posts.author',['author'=>$author->id,'name'=>\Str::slug(optional($post->author)->name)])}}" class="author d-flex align-items-center flex-wrap">
