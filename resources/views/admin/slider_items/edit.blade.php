        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">@lang('Edit slider item') </h2>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('Edit slider item')</li>
                            </ol>
                        </nav>
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.slider_items.update',['sliderItem'=>$sliderItem->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="title" class="col-form-label">@lang('Title')</label>
                                <input id="title" type="text" class="form-control @if($errors->has('title'))  is-invalid @endif" name="title" value="{{ old('title',$sliderItem->title)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="button_name" type="text" class="form-control @if($errors->has('button_name'))  is-invalid @endif" name="button_name" value="{{ old('button_name',$sliderItem->button_name)}}">
                                @include('admin._layout.partials.form_errors',['fieldName'=>'button_name'])
                            </div>
                            <div class="form-group">
                                <label for="url" class="col-form-label">@lang('Url')</label>
                                <input id="url" type="text" class="form-control @if($errors->has('url'))  is-invalid @endif" name="url" value="{{ old('url',$sliderItem->url)}}">
