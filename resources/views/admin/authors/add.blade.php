        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">@lang('Add new user') </h2>

                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.index.index')}}" class="breadcrumb-link">@lang('Dashboard')</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('admin.authors.index')}}" class="breadcrumb-link">@lang('Users')</a></li>

                                <li class="breadcrumb-item active" aria-current="page">@lang('Add new user')</li>
                            </ol>
                        </nav>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.authors.insert')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="text" class="form-control @if($errors->has('email'))  is-invalid @endif" name="email" value="{{ old('email')}}">
                                @include('admin._layout.partials.form_errors',['fieldName'=>'email'])
                            </div>
                            <div class="form-group">
                                <label for="phone_number">@lang('Phone number')</label>
                                <input id="phone_number" type="text" class="form-control @if($errors->has('phone_number'))  is-invalid @endif" name="phone_number" value="{{ old('phone_number')}}">
